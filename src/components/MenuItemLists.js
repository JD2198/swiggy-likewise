...
const MenuItemLists = ({items}) => {
    ...
    return (
        <div>
           {items.map((item) => (
            <div key={item.card.info.id}  className="p-2 m-2 border-gray-200 border-b-2 justify-items-left flex justify-between">
                ...
                <div className="w-3/12 p-4">
                    ...
                    <button className="bg-amber-50  font-black shadow-2xl rounded-xl px-2 cursor-pointer text-green-800 m-1">Add +</button>
                    </div>
